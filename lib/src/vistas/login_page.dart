...
class _LoginPageState extends State<LoginPage> {
  ...
  _showPerfilUser(FirebaseUser curUserEmailPss) async {
    ...
    Navigator.of(context).push(MaterialPageRoute(
        builder: (ctx) => Scaffold(
            ...
            appBar: AppBar(
              title: Text(
                "Welcome " + curUserEmailPss.email.substring(0, 4),
            ...
            body: Stack(children: [
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    boxShadow: <BoxShadow>[
                      BoxShadow(color: Colors.blue, blurRadius: 3.8)
                    ],
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      boxShadow: <BoxShadow>[
                        BoxShadow(
                            color: Colors.lightBlueAccent, blurRadius: 2.65)
                      ],
                      borderRadius: BorderRadius.circular(100)),
                ),
              ),
                      ...
                      child: Card(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              IconButton(
                                icon: Image.network(
                                    "http://icons.iconarchive.com/icons/graphicloads/100-flat-2/128/chat-2-icon.png"),
                                onPressed: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                      ...
                      child: Card(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              IconButton(
                                icon: Image.network(
                                    "http://icons.iconarchive.com/icons/dapino/baby-boy/128/baby-idea-icon.png"),
                                onPressed: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                      ...
                      child: Card(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              IconButton(
                                icon: Image.network(
                                  "https://icons.iconarchive.com/icons/musett/coffee-shop/128/Newspaper-icon.png",
                                  width: 200,
                                ),
                                onPressed: () {
                                  Navigator.push(
        ...
        child: Column(
          children: [
            Column(
              children: [
                CircleAvatar(
                  backgroundImage: NetworkImage(curUserEmailPss.photoUrl == null
  ...
  void _singUserGoogle(FirebaseAuth usuarioGoogle) async {
    ...
    final GoogleSignInAuthentication googleAutxh =
